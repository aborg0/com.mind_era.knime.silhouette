 ...
 */
public class FastSilhouetteNodePlugin extends Plugin {
    // The shared instance.
    private static FastSilhouetteNodePlugin plugin;

    /**
     * The constructor.
     */
    public FastSilhouetteNodePlugin() {
        super();
        plugin = this;
    }
     ...
     */
    public static FastSilhouetteNodePlugin getDefault() {
        return plugin;
    }
